class dvn {
  ...
  file { '/root/dvn-install.sh':
    source => 'puppet:///modules/bucket/root/dvn-install.sh',
    owner  => 'root',
    group  => 'root',
    mode   => '0600',
  }

  file { '/root/dvn-vagrant-install.pl':
    source => 'puppet:///modules/bucket/root/dvn-vagrant-install.pl',
    owner  => 'root',
    group  => 'root',
    mode   => '0600',
  }
